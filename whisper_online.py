...
class ASRBase:
    ...
    def set_condition_on_previous_text(self, enabled):
        self.condition_on_previous_text = bool(enabled)

    def set_transcribe_options(self, **kwargs):
        self.transcribe_kargs.update(kwargs)
...
class FasterWhisperASR(ASRBase):
    ...
    def load_model(self, modelsize=None, cache_dir=None, model_dir=None):
        ...
        compute_type = getattr(self, "_compute_type", "float16")
        model = WhisperModel(
            model_size_or_path,
            device=device,
    ...
    def ts_words(self, segments):
        o = []
        no_speech_threshold = self.transcribe_kargs.get("no_speech_threshold", 0.9)
    ...
    def use_vad(self, vad_parameters=None):
        ...
        if vad_parameters is not None:
            self.transcribe_kargs["vad_parameters"] = vad_parameters
